...
# This script can be run inside AEDT directly to set up the RelativeCS for permanent magnet magnetization assignment, and force parameter assignment
# ----------------------------------------------
import ScriptEnv
ScriptEnv.Initialize("Ansoft.ElectronicsDesktop")
oDesktop.RestoreWindow()
oProject = oDesktop.SetActiveProject("Qi2_MagnetLatch_MagneticForce")
oDesign = oProject.SetActiveDesign("Maxwell3DDesign1") # Change the design name accordingly
